                ...
                items={[
                  {
                    ...
                    label: (
                      <div className="projcollaspe-head">
                        <h3 className="projname">
                          ...
                          <img src={`data:image/jpeg;base64,${project[5]}`} alt="Project" style={{ width: '350px', height: '350px' }} />
                    ...
                    children: (
                      <div>
                        <Link style={{ textAlign: "center" }} className="projedit-btn" to={`/myproject/${project[0]}/${project[6]}`}>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            ...
                            <Link to={`/myproject/edit/${project[0]}/${project[6]}`} className="projedit-btn" style={{ marginLeft: '650px' }}>
                    ...
                    <Button type="link" 
                      ...
                      onClick={() => Deleteprojuct(project[6])} 
                      />
                      }
                    />,
                  },
