...
async def crawl_endpoint():
    try:
        ...
        insert_query11 = ('INSERT INTO project(PName,PTarget,PDes,username,statecrawl,image) VALUES(%s, %s, %s, %s ,%s ,%s)')
        values11 = (project_name, scope_url, description_name, user,0,screenshot)
